...
const Checkout = () => {
 ...
 const useStyle = makeStyles({
  ...
  checkoutMainBoxStyle: {
   background: "rgba(71, 68, 228, 0.1)",
   paddingTop: "3em",
   paddingBottom: "6em",
   minHeight: "60vh",
  },
 ...
 const stripePromise = loadStripe(
  "pk_test_51KY5pzBhGIe0XjcTQNXuMIWNscJ8fMmj447TgdU7Mlrb7cjx43cEvuy1MZ4oWb2bnekusTSkUFjwZPQpqrlSgSP200vUsiOVTp"
 );

 return (
  <>
   <Box className={navigationBgStyle}>
    <Navigation />
   </Box>
   <Box className={checkoutMainBoxStyle}>
    <Container>
     <form onSubmit={handleSubmit(onSubmit)}>
      <Box className={checkoutBoxStyle}>
       ...
       <input style={orderBtnStyle} type="submit" value="Save Info" />
      </Box>
     </form>
     <YourOrders />
